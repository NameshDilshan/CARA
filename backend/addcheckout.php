...
$sql = "INSERT INTO `caradb`.`checkout` ( `products`, `name`, `email`, `address`, `city`, `province`, `zip`, `nameonthecard`, `ccardnumber`, `expmonthandyear`, `cvv`, `customerid`)
VALUES ( '$products','$name','$email','$address','$city','$province','$zip','$nameonthecard','$ccardnumber','$expmonthandyear','$cvv', '$customerid') ";

if(mysqli_query($conn, $sql)){ 
    echo "<script>alert('Item bought successfully!!'); document.location='/CARA/index.php'</script>";
} else{
